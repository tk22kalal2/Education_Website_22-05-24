document.addEventListener("DOMContentLoaded", function () {
    ...
    const htmlFiles = [
        { file: "Plugins/anatomyp.html", fileName: "ANATOMY", platformName: "PREPLADDER" },
        { file: "Plugins/biochemestryp.html", fileName: "BIOCHEMESTRY", platformName: "PREPLADDER" },
        // Add more entries for other HTML files if needed
    ];
